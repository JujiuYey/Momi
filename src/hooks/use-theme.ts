...
const THEME_COLORS: Record<string, { primary: string; primaryForeground: string }> = {
  ...
  amber: { primary: "oklch(76.8% 0.145 70deg)", primaryForeground: "oklch(20.5% 0 0deg)" },
  yellow: { primary: "oklch(87.8% 0.157 85deg)", primaryForeground: "oklch(20.5% 0 0deg)" },
  lime: { primary: "oklch(72.8% 0.219 130deg)", primaryForeground: "oklch(20.5% 0 0deg)" },
  ...
  cyan: { primary: "oklch(57.7% 0.189 229.62deg)", primaryForeground: "oklch(20.5% 0 0deg)" },
